...
​현재 티맥스소프트에서 쿠버네티스 기반 웹 IDE 개발중입니다.

자바, 타입스크립트 등 여러가지를 배우며 정신이 없지만,
...
- 쿠버네티스 기반 웹 IDE
  - 백엔드(spring) user CRUD, 프로젝트 pod 생성 삭제
  - rook으로 pod간 디렉터리 공유
  - 사용자 페이지 (react/material ui)
- 우버이츠 클론코딩 / [git hub 링크](https://github.com/hunman89/nuber-eats-backend)
  - nestJS
